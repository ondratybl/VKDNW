...
def compute_nas_score(AnyPlainNet, random_structure_str, gpu, args, trainloader=None, lossfunc=None):
    ...
    if args.zero_shot_score.lower() != 'vkdnw':
        raise NotImplementedError("Use 'evolutionary_search_others.py' or 'evolutionary_search_az.py' for other metrics")
...
def main(args, argv):
    ...
    while loop_count < args.evolution_max_iter:
        ...
        for key in ['complexity', 'expressivity', 'trainability', 'progressivity']:
